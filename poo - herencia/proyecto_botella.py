...
class BotellaPlastica(Botella):
    ...
    def imprimir_datos(self):
        ...
        super().imprimir_datos()  # Llamar al metodo de la clase base
...
botella_plastica = BotellaPlastica("Plastico", 500, "Cilindrica", "Moderno", "Logo de la marca", "Tapa Hermetica")
