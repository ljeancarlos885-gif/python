...
class BaseDatosAnimal:
    ...
    def eliminar_animales(self, nombre):
        ...
        if nombre in self.animal:
            ...
            print(f'animales "{nombre}" eliminada correctamente.')
        else:
            print(f'No se encontro la animales "{nombre}".')
...
def menu():
    ...
    while True:
        ...
        print("2. Agregar varias animales")
        ...
        if opcion == "1":
            ...
            nombre = input("Ingrese los animales a contar: ")
