...
class BaseDatosvehiculo:
    ...
    def insertar_vehiculo(self, posicion, vehiculo):
        """Inserta  vehiculo en una posicion especifica."""
        self.vehiculo.insert(posicion, vehiculo)
        print(f'vehiculo "{vehiculo}" insertada en la posicion {posicion}.')

    def eliminar_vehiculo(self, nombre):
        """Elimina  vehiculo por su nombre."""
    ...
    def eliminar_por_posicion(self, posicion):
        ...
        try:
            vehiculo_eliminado = self.vehiculo.pop(posicion)
    ...
    def contar_vehiculo(self, nombre):
    ...
    def ordenar_vehiculo(self):
        """Ordena los vehiculo alfabeticamente."""
        self.vehiculo.sort()
        print("Los vehiculo fueron ordenados alfabeticamente.")

    def invertir_orden(self):
        """Invierte el orden actual de los vehiculo."""
        self.vehiculo.reverse()
        print("El orden de los vehiculo fue invertido.")

    def mostrar_vehiculo(self):
        """Muestra todas los vehiculo de la lista."""
...
def menu():
    ...
    while True:
        ...
        print("2. Agregar varios vehiculos")
        ...
        print("8. Ordenar vehiculos ")
        print("9. Invertir orden")
        print("10. Mostrar todas los vehiculo")
        print("0. Salir")

        opcion = input("Seleccione una opcion: ")

        if opcion == "1":
            nombre = input("Ingrese el vehiculo :")
            base.crear_vehiculo(nombre)

        elif opcion == "2":
            nombres = input("ingrese varios vehiculos separados por , : ")
            ...
            base.insertar_vehiculo(pos, nombre)

        elif opcion == "4":
            nombre = input("Ingrese el vehiculo a eliminar: ")
            base.eliminar_vehiculo(nombre)
            ...
            nombre = input("Ingrese el vehiculo a contar: ")
            base.contar_vehiculo(nombre)
