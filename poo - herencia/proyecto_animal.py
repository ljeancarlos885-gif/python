...
class Animal:
    ...
    def moverse(self):
        ...
        texto = "pueden desplazarse en cual quuier direccion"
        return texto

    def comunicacion(self):
        """suelen comunicarse con su mismma especie"""
        texto = "utlizan sonidos o gestos para comunicarsen"
        return texto

    def reproduccion(self):
        """pueden reproducirse"""
        texto = "se reproducen segun su especie"
        return texto

    def alimentarse(self):
        """buscan propio alimento"""
        texto = "Se alimentan deacuerdo asu dieta"
        return texto

    def adactacion(self):
        """suelen adaptactarse al entorno en que habitan"""
        texto = "se adaptan al habitat"
        return texto
...
class Caballo(Animal):
    ...
    def moverse(self):
        texto = "galopa con rapidez alcanzandodo velocidades km/h"
        return texto
...
class Cocodrilo(Animal):
    ...
    def moverse(self):
        ...
        texto = "se desplaza arrastrandose en tierra y nadando con fuerza en el agua"
        return texto
    ...
    def adaptacion(self):
        ...
        texto = "tiene una piel gruesa y resistente al agua, y puede estar mucho tiempo bajo el agua"
        return texto
...
class Pez(Animal):
    ...
    def moverse(self):
        ...
        texto = "se desplaza nadando gracias a sus aletas y cola"
        return texto
...
class Escarabajo(Animal):
    ...
    def moverse(self):
        """los escarabajos se mueven caminando o volando"""
        texto = "se desplaza caminando con sus patas o volando con sus alas duras"
        return texto
...
class Pato(Animal):
    ...
    def moverse(self):
        ...
        texto = "se desplaza caminando, nadando y volando segun el entorno"
        return texto
...
#Algunos metodos heredados y sobrescritos
...
# Mostrar datos y comportamientos
